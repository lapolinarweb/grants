                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-6">
                        <div class="contact-wrap split split-left split-lg-left bg-white">
                            ...
                            <form method="POST" action="https://www.maharlikacoin.com/contact-us">
                                @csrf
                ...
                <div class="row">
                    ...
                    <div class="offset-lg-3 col-lg-4 col-sm-12 mb-4 mb-sm-0 d-flex justify-content-around">
                        ...
                        <div class="wgs wgs-menu">
                            ...
                            <div class="wgs-body">
                                <ul class="wgs-links">
                                    <li><a href="https://www.maharlikacoin.com/about-us">About Us</a></li>
                                    <li><a href="https://www.maharlikacoin.com/team">Meet Our Team</a></li>
